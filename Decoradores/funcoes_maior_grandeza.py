...
'''
Em Python podemos tambémm ter funções dentro de funções, que são conhecidas como Nested Functions
...
def faz_me_rir():
    def rir():
        return choice(('hahahaha', 'kkkkkkkkk', 'yayayayaayayaya'))
    return rir
...
def faz_me_rir_novamente(pessoa):
    def dando_risada():
        risada = choice(('hahahaha', 'kkkkkkkkk', 'yayayayaayayaya'))
